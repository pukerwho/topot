...
<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
	<div class="pt-40 pb-20">
		<div class="container mx-auto px-4 lg:px-0">
			...
			<h1 class="text-3xl lg:text-5xl text-center font-black mb-8"><?php the_title(); ?></h1>

			<!-- ОСНОВНОЙ БЛОК -->
			<div class="w-full flex flex-col md:flex-row bg-light rounded-lg my-0 mx-auto mb-12 px-4 lg:px-8 py-8">
				...
				<div class="w-full md:w-1/2">
					...
					<div class="mb-8">
						<a href="<?php echo carbon_get_the_post_meta('crb_portfolio_url'); ?>" class="inline-flex items-center">	
					...
					<div class="price_item_btn cursor-pointer">
						<div class="more_btn w-full">
							<div class="order_btn first-btn text-black text-center order-js" data-order="Заказать сайт">
			...
			<div>
				<div class="text-center mb-12">
					<h2 class="text-3xl lg:text-5xl font-black mb-4"><?php _e('Другие наши работы', 'treba'); ?></h2>
					<div class="text-2xl"><?php _e('Новые проекты, выполненные нашей студией', 'treba'); ?></div>	
				</div>
						...
						<div class="portfolio_archive_item flex flex-col md:flex-row md:items-center bg-light rounded-xl mb-10 md:mb-6">
							...
							<div class="portfolio_archive_item_right w-full md:w-1/2 mb-6 md:mb-0">
								...
								<div class="block md:hidden px-4">
									<a href="<?php the_permalink(); ?>" class="light-btn flex md:inline-flex justify-center items-center text-center">	
