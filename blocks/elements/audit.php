<div class="audit relative bg-third-gradien rounded-2xl px-4 md:px-16 py-8 md:py-12">
	...
	<div class="flex flex-col md:flex-row items-center md:-mx-4">
		<div class="w-full md:w-7/12 md:px-4 mb-8 md:mb-0">
			...
			<div class="inline-block text-2xl md:text-3xl font-bold text-center bg-black bg-opacity-25 rounded-lg px-8 py-2 mb-8" style="transform:rotate(-2deg);">
		...
		<div class="w-full md:w-5/12 md:px-4">
			<div class="bg-black bg-opacity-25 rounded-xl p-3 md:p-6">
				<div class="text-xl md:text-2xl text-center mb-6"><?php _e('Заполните несколько полей', 'treba'); ?></div>
				<div>
					<!-- ФОРМА -->
					<form name="form_audit">
	          <input type="text" name="Контакт" placeholder="<?php _e('Адрес вашего сайта', 'treba'); ?>" class="w-full text-black px-2 py-4 mb-4 border-2" required>
