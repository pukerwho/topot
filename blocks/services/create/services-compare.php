<div class="container mx-auto mb-20">
	...
	<div class="w-full flex items-center mb-20">
		<div class="w-2/3 pr-10">
			<img src="<?php bloginfo('template_url'); ?>/img/secretroom.jpg" alt="<?php _e('Наш первый сайт', 'treba'); ?>" class="w-full">
		</div>
	...
	<div class="w-full flex items-center mb-20">
		<div class="w-2/3 pr-10">
			<img src="<?php bloginfo('template_url'); ?>/img/secretroom.jpg" alt="<?php _e('Наша новая работа', 'treba'); ?>" class="w-full">
		</div>
		<div class="w-1/3 flex flex-col items-center pl-10">
			<div class="hand-font text-4xl text-center mb-6"><?php _e('А это новая работа. Сайт сделан в 2021 году', 'treba'); ?></div>
