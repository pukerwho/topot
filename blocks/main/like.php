<div class="like">
	<div class="container mx-auto px-4 lg:px-0 mb-20">
		<div class="bg-light rounded-lg shadow-xl py-8">
			...
			<div class="text-center text-xl md:text-2xl mb-6">
				<?php _e('Просто пришлите нам ссылку на сайт и мы скажем, сколько будет стоить разработка такого сайта', 'topot'); ?>.
			</div>
			<div class="like_content flex flex-col md:flex-row justify-center items-center">
			...
			<div class="like_success text-2xl text-center hidden"><?php _e('Супер! Дайте нам немного времени, чтобы все подсчитать. Мы отправим информацию на ваш email.', 'topot'); ?></div>
		</div>
</div>